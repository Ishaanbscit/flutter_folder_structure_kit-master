...
class TAppTheme {
  TAppTheme._(); // private theme underscore
//variable of theme or choic
  static ThemeData lightTheme = ThemeData(
    useMaterial3: true,
    fontFamily: 'Poppins',
    disabledColor: TColors.grey,
    brightness: Brightness.light, //light color
    // primaryColor:Colors.blue,
    primaryColor: TColors.primary, // primary colore
    textTheme: TTextTheme.lightTextTheme,
    chipTheme: TChipTheme.lightChipTheme,
    scaffoldBackgroundColor:
        TColors.white, //treater mostly with different screen
